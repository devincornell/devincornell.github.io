...
For this article, I will use [mypy](https://mypy-lang.org/) to type check my example code. After installing, use the following command to type check your script.
